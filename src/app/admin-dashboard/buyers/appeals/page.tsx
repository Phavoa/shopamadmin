        ...
        >
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Specify what additional evidence or documentation you need the buyer to provide for this appeal.
            </p>
            <div className="bg-gray-50 rounded-lg p-3 mb-4 text-xs text-gray-600">
              <p><span className="font-medium">Appeal:</span> {selectedAppeal?.id.slice(-8).toUpperCase()}</p>
              <p><span className="font-medium">Buyer:</span> {selectedAppeal?.resolvedName}</p>
            </div>
            <textarea
              value={evidenceNote}
              onChange={(e) => setEvidenceNote(e.target.value)}
              rows={4}
              placeholder="e.g. Please provide order confirmation emails, delivery photos, or any supporting documents that substantiate your appeal..."
