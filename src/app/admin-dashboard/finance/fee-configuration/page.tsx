...
export default function FeeConfigurationPage() {
  ...
  // Commission data
  const [beginnerViewerCap, setBeginnerViewerCap] = useState("50");
  const [beginnerCommission, setBeginnerCommission] = useState("6");
  const [bronzeViewerCap, setBronzeViewerCap] = useState("150");
  const [bronzeCommission, setBronzeCommission] = useState("5");
  const [goldViewerCap, setGoldViewerCap] = useState("3000");
  const [goldCommission, setGoldCommission] = useState("4");
  const [shoppingCommission, setShoppingCommission] = useState("3");
      ...
      <div className="p-6 space-y-6">
        ...
        >
          <h2 className="text-lg font-semibold text-black mb-6">
            Commission (by Livestream Tier + Shopping)
          </h2>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    type="text"
                    value={beginnerViewerCap}
                    onChange={(e) => setBeginnerViewerCap(e.target.value)}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={beginnerCommission}
                    onChange={(e) => setBeginnerCommission(e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    type="text"
                    value={bronzeViewerCap}
                    onChange={(e) => setBronzeViewerCap(e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                  />
                </div>
                <div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    type="text"
                    value={goldViewerCap}
                    onChange={(e) => setGoldViewerCap(e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                  />
                </div>
                <div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-200">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                onChange={(e) => setShoppingCommission(e.target.value)}
        ...
        {/* Bottom Row: 2 cards on left, 2 cards on right */}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-16 px-3 py-2 border border-gray-300 rounded-lg text-sm text-right"
                    />
                  </div>
                </div>
