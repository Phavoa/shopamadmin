...
const HubsPagination: React.FC<HubsPaginationProps> = ({
  currentPage,
  hasNext,
  hasPrev,
  isLoading,
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between px-6 py-4 border-t border-gray-200 bg-white rounded-b-lg gap-4">
      ...
      <div className="flex items-center">
        <p className="text-sm text-gray-600">
          Showing {hubsCount} hub{hubsCount !== 1 ? "s" : ""} on page {currentPage}
        </p>
      </div>
